...
from assets.edges import scored_edges, scored_edges_postgis, scored_edges_geojson
from assets.grids import scored_grids, scored_grids_postgis, scored_grids_geojson
...
defs = dg.Definitions(
    assets=[
        ...
        scored_edges_postgis, scored_edges_geojson, scored_grids_postgis,
        scored_grids_geojson
    ],
    resources={
